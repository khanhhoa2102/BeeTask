...
.beetask-nav-item:nth-child(1) { animation-delay: 0.05s; }
.beetask-nav-item:nth-child(2) { animation-delay: 0.1s; }
.beetask-nav-item:nth-child(3) { animation-delay: 0.15s; }
.beetask-nav-item:nth-child(4) { animation-delay: 0.2s; }
.beetask-nav-item:nth-child(5) { animation-delay: 0.25s; }
.beetask-nav-item:nth-child(6) { animation-delay: 0.3s; }
        ...
        <nav class="beetask-nav">
            <ul class="beetask-nav-menu">
                <li class="beetask-nav-item <%= uri.endsWith("/Home.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/Home/Home.jsp" class="beetask-nav-link" data-tooltip="Home">
                        <i class="fas fa-home"></i>
                        <span class="beetask-nav-text">Home</span>
                    </a>
                </li>
                <li class="beetask-nav-item <%= uri.endsWith("/projects.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/Projects.jsp" class="beetask-nav-link" data-tooltip="Projects">
                        <i class="fas fa-folder-open"></i>
                        <span class="beetask-nav-text">Projects</span>
                    </a>
                </li>
                <li class="beetask-nav-item <%= uri.endsWith("/Templates.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/Home/Templates.jsp" class="beetask-nav-link" data-tooltip="Templates">
            ...
            <ul class="beetask-nav-menu">
                <li class="beetask-nav-item <%= uri.endsWith("/CalendarHome.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/Home/CalendarHome.jsp" class="beetask-nav-link" data-tooltip="Today">
                        <i class="fas fa-calendar-day"></i>
                        <span class="beetask-nav-text">Today</span>
                    </a>
                </li>
                <li class="beetask-nav-item <%= uri.endsWith("/Table.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/Home/Table.jsp" class="beetask-nav-link" data-tooltip="Calendar">
                        <i class="fas fa-calendar-alt"></i>
                        <span class="beetask-nav-text">Calendar</span>
                    </a>
                </li>
                <li class="beetask-nav-item <%= uri.endsWith("/Note.jsp") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/notes" class="beetask-nav-link" data-tooltip="Notes">
            ...
            <ul class="beetask-nav-menu">
                <li class="beetask-nav-item <%= uri.endsWith("/leaderstaticservlet") ? "beetask-active" : "" %>">
                    <a href="${pageContext.request.contextPath}/leaderstaticservlet" class="beetask-nav-link" data-tooltip="Statistics">
