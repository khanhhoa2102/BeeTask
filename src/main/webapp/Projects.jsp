                ...
                <div class="content">
                    <div class="projects-section">
                        ...
                        <div class="projects-grid" id="projectsContainer">
                            ...
                            <div class="project-card" data-project-id="<%= p.getProjectId() %>" data-project-name="<%= p.getName().toLowerCase() %>"  data-project-locked="<%= p.isLocked() %>">
                                ...
                                <div class="card-content">
                                    ...
                                    <% } else { %>
                                    <div class="click-hint" style="color: red;">
                                        <i class="fas fa-lock"></i>
                                        <span>Project is locked</span>
                                    </div>
                                    <% } %>
                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="project-status">
                                        <% if (p.isLocked()) { %>
                                        <span class="status-badge" style="background-color: gray;">Locked</span>
                                        <% } else { %>
