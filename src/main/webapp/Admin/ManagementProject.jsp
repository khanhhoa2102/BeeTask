...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Admin/ManagementProject.css">
...
<form method="get" action="allprojects" class="search-form">
    <input type="text" name="keyword" placeholder="Search by project name or ID" value="${param.keyword}" />
    <select name="status">
        <option value="">All Status</option>
        <option value="locked" ${param.status == 'locked' ? 'selected' : ''}>🔒 Locked</option>
        <option value="unlocked" ${param.status == 'unlocked' ? 'selected' : ''}>🔓 Unlocked</option>
    </select>
