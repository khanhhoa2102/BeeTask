...
<!DOCTYPE html>
<% System.out.println("🧪 EnterOTP.jsp loaded from: " + request.getRequestURI()); %>
        ...
        <div class="container">
            <div class="verify-card">
                ...
                <div class="email-section">
                    <span class="email-address" id="emailAddress">@gmail.com</span>
                ...
                <form class="verify-form" id="verifyForm" action="${pageContext.request.contextPath}/verify-code" method="post">
                    ...
                    <!-- Error Message -->
                    <% String serverMessage = (String) request.getAttribute("message"); %>
                    <div class="error-message <%= serverMessage != null ? "show" : "" %>" id="errorMessage" style="<%= serverMessage != null ? "display:block;" : "display:none;" %>">
                        <span id="errorText"><%= serverMessage != null ? serverMessage : "" %></span>
                    </div>
