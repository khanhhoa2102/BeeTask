...
public class TaskDAO {
    ...
    public List<Task> getTasksByUserId(int userId) {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                task.setListId(rs.getInt("ListId")); // giữ để tương thích DB
            ...
            System.err.println("❌ Error fetching tasks by user ID: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void debugTasksForProject(int projectId) {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(projectSQL)) {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(boardSQL)) {
        ...
        String taskSQL = "SELECT t.TaskId, t.Title, t.BoardId, b.Name as BoardName, ts.Name as StatusName "
                ...
                + "INNER JOIN TaskStatuses ts ON t.StatusId = ts.StatusId "
                + "WHERE b.ProjectId = ?";
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(taskSQL)) {
